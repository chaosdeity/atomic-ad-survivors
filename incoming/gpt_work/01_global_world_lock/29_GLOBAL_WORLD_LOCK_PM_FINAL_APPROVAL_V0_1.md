...
상태: **PM FINAL APPROVAL SHEET**  
대상: **FINAL GLOBAL WORLD LOCK CANDIDATE**  
주의: 이 문서는 승인 체크 전까지 실제 FINAL GLOBAL WORLD LOCK 확정이 아니다.
...
[ ] APPROVE FINAL GLOBAL WORLD LOCK V0.2

[ ] HOLD

[ ] RETURN FOR REVISION

체크 전 상태: **PM FINAL APPROVAL REQUIRED**

승인 체크 전에는 실제 `GLOBAL_WORLD_STRUCTURE_LOCK_V0_2.md`를 생성하지 않는다.
