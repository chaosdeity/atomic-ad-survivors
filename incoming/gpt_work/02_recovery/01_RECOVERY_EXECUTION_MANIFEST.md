...
| `map-evolution-proof-20260906-055930/control01/control_results.json` | `docs/world/evidence/map_evolution_20260906/control_results.json` | map-evolution-proof | text | 1596 | `8e84a66d528f343023f20496df78cd50583028f06e80aa3cba17f877dcd7df59` | RECOVERED_PM_CORRECTED_PATH | PASS | WORLD_SYSTEM_PROOF | PM source-path correction resolved. old approved path: `proof02/control01/control_results.json`; corrected source: `control01/control_results.json`; local SHA verified before upload; recovery commit `1f0731e89d900071d499ba323d08548f1e5c3453` |
...
| `motion-proof-20260905-145830/build_robot_v03.py` | `docs/archive/technical_proofs/motion_pipeline/build_robot_v03.py` | motion-proof | text | 9728 | `ffb25274ccc6a51019fc86f1c05f6ebcd0ac40d64f87a6539f4f609fe9d8d6eb` | RECOVERED_PM_CORRECTED_PATH | PASS | TECH_PIPELINE_PROOF | PM source-path correction resolved. old approved path: `run03/build_robot_v03.py`; README confirms root generator; local SHA verified before upload; recovery commit `1f0731e89d900071d499ba323d08548f1e5c3453` |
| `motion-proof-20260905-145830/assemble.py` | `docs/archive/technical_proofs/motion_pipeline/assemble.py` | motion-proof | text | 2151 | `fa905ebb524814408be9f055be3b30151ab375de37a0a30b4ff62cf8a2cb0957` | RECOVERED_PM_CORRECTED_PATH | PASS | TECH_PIPELINE_PROOF | PM source-path correction resolved. old approved path: `run03/assemble.py`; README confirms root assembly/check script; local SHA verified before upload; recovery commit `1f0731e89d900071d499ba323d08548f1e5c3453` |
...
- Binary pending: 5
- Exact approved source path missing: 0
