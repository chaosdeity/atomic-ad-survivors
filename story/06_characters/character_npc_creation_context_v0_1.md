...
퇴원 보류 환자는 힐러가 아니라 퇴원/입원 판정 절차를 비트는 후보여야 한다.
...
```text
1. 4번 퇴원 보류 환자를 상세 결재한다.
2. 퇴원 보류 환자가 힐러가 아니라 퇴원/입원 판정 절차를 비트는 후보인지 검증한다.
