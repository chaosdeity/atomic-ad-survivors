...
다음 작업은 5번 한이루 / RETURN-05 / 반송 수취인 프로필 v1.0이다.
```
...
다음 상세화 대상은 5번 한이루 / RETURN-05 / 반송 수취인 프로필 v1.0이다.
```
...
```text
1. 5번 한이루 / RETURN-05 / 반송 수취인 프로필 v1.0을 작성한다.
2. 반송 수취인은 윤서의 반품 도장과 겹치지 않게 송장/포장끈/반송 스티커 중심으로 유지한다.
