...
다음 작업은 5번 한이루 / RETURN-05 / 반송 수취인 조건부 해소 문서다.
```
...
5 한이루 / RETURN-05 / R03 물류·반품 / 반송 수취인
...
5~7번 이름/코드명은 playable_20_name_registry_v0_1.md의 L3 후보로 둔다.
5번 반송 수취인 상세 결재는 조건부 통과했다.
다음 상세화 대상은 5번 한이루 / RETURN-05 / 반송 수취인 조건부 해소 문서다.
```
...
```text
1. 5번 반송 수취인 조건부 해소 문서에서 윤서 중복 방지선을 고정한다.
2. 반송 수취인은 윤서의 반품 도장과 겹치지 않게 송장/포장끈/반송 스티커 중심으로 분리한다.
3. 플레이어블 20인 이름 레지스트리 v0.1은 작성 완료되었다. 이후 5~7번 프로필 작성 때 이름/코드명을 확정 또는 수정한다.
