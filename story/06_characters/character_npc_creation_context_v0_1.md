...
4번 퇴원 보류 환자는 상세 결재 결과 조건부 통과다.
다음 상세화 대상은 퇴원 보류 환자 보완 문서다.
```
...
퇴원 보류 환자는 힐러가 아니라 퇴원/입원 판정 절차를 비트는 후보여야 하며, R02-L01~L03 범위를 넘기지 않는다.
...
```text
1. 퇴원 보류 환자 보완 문서를 작성한다.
2. 힐러화 방지, R02-L01~L03 해금 범위, HP 0 재입원/퇴원 취소/보험 심사 재개 연출을 잠근다.
