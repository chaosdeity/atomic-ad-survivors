...
## 5. 초반 2~3번째 주인공 후보의 방향

리오를 8번 후보로 보류했으므로, 초반 2~3번째 주인공은 아래 영역에서 찾아야 한다.
...
```text
초반 2~3번째 캐릭터가 세계를 너무 넓히면 R01의 힘이 흐려진다.
...
2. 윤서 1번, 리오 8번 후보를 잠금 슬롯으로 둔다.
3. 2~7번은 E01/R01/R02/R03/R04/R08 안에서 다시 찾는다.
4. 로스터 중복 검사를 한다.
5. 초반 2번째 주인공 후보 1명만 상세 결재한다.
