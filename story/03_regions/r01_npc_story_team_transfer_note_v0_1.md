...
26. R01_REMAINING_WORK_LIST_V0_1.md
...
15. R01 NPC 12명 상세화 이후 남은 본명/분기/상태 변화/구현 전환 작업의 우선순위가 명확한가?
16. 윤서가 왜 사람을 바로 데려오지 못하거나 강제로 데려올 수 없는지 유저가 이해할 수 있는가?
17. R01 NPC들이 캠페인화 인간을 "껍데기"가 아니라 "선택한 사람들"로 보이게 하는가?
```
