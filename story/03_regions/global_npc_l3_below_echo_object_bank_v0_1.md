...
후속 1차 샘플 문구에서 L3 52 / L2 82 / L1 55 / L0 51개 표본을 작성했다.
후속 1차 샘플 문구 QA에서 240개 표본의 은행형 표현 유지와 금지선 통과를 검수했다.
후속 적용 기준에서 240개 표본을 스토리/레벨/오브젝트/상태 반응으로 넘기는 기준을 작성했다.
후속 적용 티켓에서 240개 sample_id를 240개 ticket_id로 1:1 연결했다.
후속 적용 티켓 QA에서 ticket_id 연속성과 캠페인별 수량을 검수했다.
후속 핸드오프 기준에서 엔진/레벨/UI/오디오 전달 필드와 금지선을 작성했다.
```
