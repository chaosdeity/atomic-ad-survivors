...
5. 전역 NPC 스토리 네트워크 1차 실제 산출 완료.
6. 이후 E02 승격 후보 v0.1 프로필 또는 CLAUSE-11 상세 결재로 진행한다.
```
...
7. 전역 NPC 스토리 네트워크 1차 실제 산출물이 작성되어 420개 씨앗 기준으로 외부 광역권을 비우지 않는다.
...
전역 NPC는 420개 씨앗 기준의 1차 실제 산출물로 연결되었다.
```
