...
바로 다음 NPC 작업 포인터는 **E02 첫 외부 슬라이스 NPC 예산**으로 넘긴다.
...
- 이제 R01 안에서 새 NPC를 더 늘리지 않고, E01의 다른 지역 보조 NPC도 최소 수량으로 잘랐다.
...
E01 R02/R03/R04/R08 보조 NPC 최소안은 완료되었다.
다음 NPC 작업은 E02 첫 외부 슬라이스 NPC 예산이다.
```
