...
검수 결과는 story/03_regions/global_npc_review_report_v0_1.md에서 조건부 통과로 정리했다.
통과 슬롯은 story/03_regions/global_npc_passed_slot_registry_v0_1.md에서 L5/L4 192개와 L3 이하 1,856개로 분리했다.
L3 이하 은행은 story/03_regions/global_npc_l3_below_echo_object_bank_v0_1.md에서 1,856개로 정리했다.
L3 이하 은행 검수는 story/03_regions/global_npc_l3_below_bank_review_v0_1.md에서 통과로 정리했다.
L3 이하 세부 문구 샘플링 기준은 story/03_regions/global_npc_l3_below_text_sampling_standard_v0_1.md에서 240개 1차 표본으로 제한했다.
L3 이하 1차 샘플 문구는 story/03_regions/global_npc_l3_below_first_text_samples_v0_1.md에서 240개로 작성했다.
```
...
| `story/03_regions/global_npc_review_report_v0_1.md` | 작성 완료 |
| `story/03_regions/global_npc_passed_slot_registry_v0_1.md` | 작성 완료 |
| `story/03_regions/global_npc_l3_below_echo_object_bank_v0_1.md` | 작성 완료 |
...
전역 NPC 통과 슬롯 레지스트리에서 통과 슬롯 2,048개를 다음 은행형 산출물 기준으로 정리했다.
전역 NPC L3 이하 잔향/오브젝트 은행에서 L3 이하 1,856개를 직접 대면 없이 은행화했다.
