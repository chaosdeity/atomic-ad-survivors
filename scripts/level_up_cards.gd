...
const CARDS := [
	{
		...
		"name": "반품 라벨",
		"description": "반품 도장이 표식을 붙이고 표식 처리가 처리량을 더 만듭니다.",
		"effect_text": "차징 표식 강화 / 표식 처리량 +",
	...
	},
	{
		"id": "tool_flyer_pop",
		"name": "전단 폭죽",
		"description": "적 처리가 전단 폭발로 이어지고 연쇄 처리가 쉬워집니다.",
		"effect_text": "처리 폭발 해금 / 폭발 처리량 +",
