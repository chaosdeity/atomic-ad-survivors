...
const ZONE_ANCHORS := {
	"silence_edge_start": Vector2(-600, 170),
	"subdivision_loop_center": Vector2(-105, 28),
	"model_house_node_anchor": Vector2(510, -238),
	"drain_pocket_anchor": Vector2(260, 270),
	"fake_return_route_anchor": Vector2(-500, -205),
}
...
const OBJECT_PLACEMENTS := [
	{"id": "silence_edge_ground_band", "asset_key": "r01_ground_silence_edge_wide_patch", "zone_id": "silence_edge_start", "pos": Vector2(-490, 0), "kind": "floor", "size": Vector2(460, 810), "pivot": Vector2(230, 405), "state": STATE_ALL, "tags": ["silence_edge", "wide_patch"]},
	{"id": "subdivision_loop_road_patch", "zone_id": "subdivision_loop_center", "offset": Vector2(0, 0), "kind": "subdivision_road", "state": STATE_ALL},
	{"id": "model_house_visual_axis", "zone_id": "subdivision_loop_center", "offset": Vector2(344, -162), "kind": "model_axis", "state": STATE_ALL},
	...
	{"id": "corridor_silence_to_loop", "asset_key": "r01_ground_corridor_silence_to_loop", "zone_id": "silence_edge_start", "pos": Vector2(-352, 99), "kind": "travel_path", "state": STATE_ALL, "tags": ["silence_edge", "subdivision_loop"]},
	{"id": "corridor_loop_to_model_house", "asset_key": "r01_ground_corridor_loop_to_model_house", "zone_id": "subdivision_loop_center", "pos": Vector2(202, -105), "kind": "travel_path", "state": STATE_ALL, "tags": ["subdivision_loop", "model_house"]},
	{"id": "corridor_loop_to_drain", "asset_key": "r01_ground_corridor_loop_to_drain", "zone_id": "subdivision_loop_center", "pos": Vector2(78, 149), "kind": "travel_path", "state": STATE_ALL, "tags": ["subdivision_loop", "drain"]},
	{"id": "corridor_loop_to_fake_return", "asset_key": "r01_decal_fake_return_corridor_hint", "zone_id": "subdivision_loop_center", "pos": Vector2(-302, -88), "kind": "travel_path", "state": STATE_ALL, "tags": ["subdivision_loop", "fake_return", "not_recovery_ui"]},
