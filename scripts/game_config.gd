...
const AUTO_ASSIST_DAMAGE_MULT := 0.58
const AUTO_MARKED_DAMAGE_MULT := 1.35
const MANUAL_STAMP_COOLDOWN := 0.62
const MANUAL_STAMP_DAMAGE := 22.0
const MANUAL_STAMP_RANGE := 62.0
const MANUAL_STAMP_WIDTH := 17.0
const MANUAL_STAMP_MARK_DURATION := 2.4
const MANUAL_STAMP_SOURCE_RADIUS := 72.0
const MATCH_DURATION := 300.0

const ENEMY_HP := 45.0
const ELITE_HP := 180.0
