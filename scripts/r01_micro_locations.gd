...
const LOCATION_DEFS := [
	{
		...
		"entry_phrase": "문은 열리지 않습니다. 대신 문틈과 센서가 짧게 살아납니다.",
		"exit_phrase": "현관 앞에서 한 걸음 물러났습니다.",
		"risk_level": 2,
		...
		"inspection_points": [
			{
				...
				"display_name": "문틈 음성",
				"prompt": "문틈 음성 확인",
				"first_phrase": "문틈에서 오늘 저녁 숫자만 세는 목소리가 새어 나옵니다.",
				"repeat_phrase": "문틈 목소리는 같은 숫자에서 다시 끊깁니다.",
				"interaction_type": "조사",
				"risk_hint": "반복 현관의 경고선이 짧게 울립니다.",
			...
			},
			{
				...
				"repeat_phrase": "센서 주파수는 이미 정비대 기록으로 접혔습니다.",
				"interaction_type": "검증",
	...
	},
	{
		...
		"entry_phrase": "유리 안쪽의 가족사진이 웃는 얼굴을 다시 맞춥니다.",
		"exit_phrase": "창문 앞 잔향에서 물러났습니다.",
		"risk_level": 2,
	...
	},
	{
		...
		"entry_phrase": "모델하우스 로비는 입장을 허락하지 않고 접수 절차만 앞으로 밀어냅니다.",
		"exit_phrase": "로비 심사선 밖으로 빠져나왔습니다.",
		"risk_level": 3,
		...
		"inspection_points": [
			{
				...
				"display_name": "접수대",
				"prompt": "접수대 기록 확인",
				"first_phrase": "접수대는 방문자보다 실종 칸을 먼저 채웁니다.",
			...
			},
			{
				...
				"display_name": "가족 구성표",
				"prompt": "가족 구성표 대조",
				"first_phrase": "가족 구성표는 빈칸을 사람 수보다 먼저 정상 가족 수로 고칩니다.",
	...
	},
	{
		...
		"entry_phrase": "배수로 안쪽에서 광고음이 낮아지고 젖은 종이가 빛을 먹습니다.",
		"exit_phrase": "배수로 입구의 낮은 신호에서 물러났습니다.",
		"risk_level": 2,
		...
		"inspection_points": [
			{
				...
				"tag_hint": "직접 보상 없음. 흔적 보관실 반응 후보",
	...
	},
	{
		...
		"entry_phrase": "가짜 회수 표지 뒤쪽은 쉼터처럼 보이지만 보급소 침묵이 없습니다.",
		"exit_phrase": "가짜 쉼터 뒤쪽에서 빠져나왔습니다.",
		"risk_level": 3,
		...
		"inspection_points": [
			{
				...
				"display_name": "보급소와 닮은 표식",
				"prompt": "닮은 표식 검증",
				"first_phrase": "표식은 보급소 색을 흉내 내지만 빈 주파수는 없습니다.",
				"repeat_phrase": "닮은 표식은 이미 보급소 인증 아님으로 접혔습니다.",
				"interaction_type": "검증",
