...
보급소/NPC 기준:
59. story/02_hub/silence_outpost.md
60. story/02_hub/npcs.md
61. story/02_hub/mina_npc_profile_v1_0.md
62. story/02_hub/mina_npc_drama_draft_v0_1.md
63. story/05_progression/run_story_hooks.md
64. story/05_progression/story_trigger_schema.md
...
25. 다음 작업은 9~12번 중반 플레이어블 후보군 선정이다.
26. NPC는 플레이어블 로스터와 별도로 만든다.
27. NPC도 이름만 나열하지 말고, 시설/상태 반응/잘못 믿는 것/플레이어블이 아닌 이유를 붙인다.
...
다음 작업은 9~12번 중반 플레이어블 후보군 선정만 다룬다.
...
다음에는 9~12번 중반 플레이어블 후보군 선정만 작성하라.
