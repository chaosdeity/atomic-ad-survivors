...
보급소/NPC 기준:
46. story/02_hub/silence_outpost.md
47. story/02_hub/npcs.md
48. story/02_hub/mina_npc_profile_v1_0.md
49. story/02_hub/mina_npc_drama_draft_v0_1.md
50. story/05_progression/run_story_hooks.md
51. story/05_progression/story_trigger_schema.md
...
13. 다음 작업은 5번 한이루 / RETURN-05 / 반송 수취인 상세 결재다.
14. NPC는 플레이어블 로스터와 별도로 만든다.
15. NPC도 이름만 나열하지 말고, 시설/상태 반응/잘못 믿는 것/플레이어블이 아닌 이유를 붙인다.
...
다음 상세 결재는 5번 한이루 / RETURN-05 / 반송 수취인만 다룬다.
...
다음에는 5번 한이루 / RETURN-05 / 반송 수취인만 상세 결재하라.
