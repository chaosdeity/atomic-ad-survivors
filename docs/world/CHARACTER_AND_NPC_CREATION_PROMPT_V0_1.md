...
E01 초반에 8명 주인공이 모두 있는 것이 아니며, 9~12번은 E02/E07/E09/E11 후보군으로 선정되었다. 13~20번은 각자 열리는 E02~E12 현실 광역권에 맞춰 현지명/다국적 이름으로 재판정한다.
```
...
보급소/NPC 기준:
62. story/02_hub/silence_outpost.md
63. story/02_hub/npcs.md
64. story/02_hub/mina_npc_profile_v1_0.md
65. story/02_hub/mina_npc_drama_draft_v0_1.md
66. story/05_progression/run_story_hooks.md
67. story/05_progression/story_trigger_schema.md
...
- 리오는 8번째 플레이어블 후보로 프로필 v1.0 고정 판정을 받았다.
...
26. 9번 Mika Arakawa / GATE-09 / 미카, 막차 환승 심사자를 다음 상세 결재 대상으로 둔다.
27. NPC는 플레이어블 로스터와 별도로 만든다.
28. NPC도 이름만 나열하지 말고, 시설/상태 반응/잘못 믿는 것/플레이어블이 아닌 이유를 붙인다.
...
다음 작업은 9번 GATE-09 프로필 v1.0 작성만 다룬다.
...
다음에는 9번 GATE-09 프로필 v1.0만 작성하라.
