...
보급소/NPC 기준:
42. story/02_hub/silence_outpost.md
43. story/02_hub/npcs.md
44. story/02_hub/mina_npc_profile_v1_0.md
45. story/02_hub/mina_npc_drama_draft_v0_1.md
46. story/05_progression/run_story_hooks.md
47. story/05_progression/story_trigger_schema.md
...
현재 기준에서는 `story/06_characters/playable_20_roster_blueprint_v0_1.md`, `story/06_characters/patch_playable_2nd_slot_final_decision_v0_1.md`, `story/06_characters/playable_slots_3_to_7_candidate_selection_v0_1.md`를 먼저 보고, 20명을 다시 나열하지 않는다. 다음 작업은 **4번 퇴원 보류 환자 상세 결재**이다.
