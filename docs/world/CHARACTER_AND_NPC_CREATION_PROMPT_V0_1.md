...
보급소/NPC 기준:
44. story/02_hub/silence_outpost.md
45. story/02_hub/npcs.md
46. story/02_hub/mina_npc_profile_v1_0.md
47. story/02_hub/mina_npc_drama_draft_v0_1.md
48. story/05_progression/run_story_hooks.md
49. story/05_progression/story_trigger_schema.md
...
11. 다음 작업은 퇴원 보류 환자 프로필 v1.0이다.
12. NPC는 플레이어블 로스터와 별도로 만든다.
13. NPC도 이름만 나열하지 말고, 시설/상태 반응/잘못 믿는 것/플레이어블이 아닌 이유를 붙인다.
...
다음 상세 결재는 퇴원 보류 환자 프로필 v1.0만 다룬다.
