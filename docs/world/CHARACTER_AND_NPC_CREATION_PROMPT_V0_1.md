...
보급소/NPC 기준:
57. story/02_hub/silence_outpost.md
58. story/02_hub/npcs.md
59. story/02_hub/mina_npc_profile_v1_0.md
60. story/02_hub/mina_npc_drama_draft_v0_1.md
61. story/05_progression/run_story_hooks.md
62. story/05_progression/story_trigger_schema.md
...
23. 다음 작업은 리오 / RIO-08 조건부 해소 문서다.
24. NPC는 플레이어블 로스터와 별도로 만든다.
25. NPC도 이름만 나열하지 말고, 시설/상태 반응/잘못 믿는 것/플레이어블이 아닌 이유를 붙인다.
...
다음 작업은 리오 / RIO-08 조건부 해소 문서만 다룬다.
...
다음에는 리오 / RIO-08 조건부 해소 문서만 작성하라.
