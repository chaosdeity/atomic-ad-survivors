...
NPC 대량 제작팀 프롬프트 v0.1 작성 완료.
완료 문서:
docs/world/NPC_MASS_PRODUCTION_TEAM_PROMPT_V0_1.md

용도:
NPC를 12명 단위 최소안으로 끝내지 않고, E01 120~170개 후보 풀과 전역 300~500개 씨앗을 L5~L0 계층으로 대량 생산하기 위한 제작팀 전달 프롬프트.
...
E02 이후 외부 광역권 후보는 `docs/world/GLOBAL_ADMIN_REAL_LOCATION_MAP_V0_1.md`를 기준으로 한다.
유저에게는 실명 지명을 숨기되, 관리자/제작자는 실제 현실 권역과 인프라 축을 확인해야 한다.
E01 초반에 8명 주인공이 모두 있는 것이 아니며, 기존 1~13번은 프로필 산출 번호와 최종 해금 순번을 분리해야 한다. 14~20번은 각자 열리는 E02~E12 현실 광역권에 맞춰 현지명/다국적 이름으로 재판정한다.
```
...
55. story/06_characters/quiet_07_profile_v1_0.md
56. story/06_characters/rio_08_playable_lock_review_v0_1.md
57. story/06_characters/rio_08_playable_condition_patch_v0_1.md
58. story/06_characters/rio_08_profile_v1_0.md
59. story/06_characters/playable_slots_9_to_12_candidate_selection_v0_1.md
60. story/06_characters/gate_09_playable_decision_v0_1.md
61. story/06_characters/gate_09_playable_condition_patch_v0_1.md
62. story/06_characters/gate_09_profile_v1_0.md

보급소/NPC 기준:
63. story/02_hub/silence_outpost.md
64. story/02_hub/npcs.md
65. story/02_hub/mina_npc_profile_v1_0.md
66. story/02_hub/mina_npc_drama_draft_v0_1.md
67. story/05_progression/run_story_hooks.md
68. story/05_progression/story_trigger_schema.md
...
- PATCH-02는 legacy_code와 기능 산출물로 보존한다. 출시 초기 +1 확정은 아니며 U1~U4 보류다.
...
- 8번 리오 플레이어블 잠금 재검토는 조건부 통과했다. 8번 슬롯은 유지하되 직접 해금은 중반 체류·숙박권까지 보류한다.
- 8번 리오 조건부 해소 문서는 통과로 승격 가능 판정으로 완료되었다. 핵심 문장은 "그 방은 비어 있지 않았습니다."다.
...
- 리오는 8번째 플레이어블 후보로 프로필 v1.0 기능 산출물 보존 판정을 받았고 중반 해금까지 보류한다.
...
3. 윤서는 1번 슬롯으로 잠근다.
4. PATCH-02는 legacy_code와 기능 산출물로 보존하되 출시 초기 +1 확정은 아니며 U1~U4 보류다.
5. OPEN-HOST는 3번 산출 번호를 보존하되 R01 NPC 선등장을 유지하고 출시 초기 U5 전환은 금지한다.
...
21. 7번 백여울 / QUIET-07 / 침묵권 피난자 프로필 v1.0은 완료되었다.
22. 8번 리오 플레이어블 잠금 재검토는 조건부 통과했다.
23. 8번 리오 조건부 해소 문서는 통과로 승격 가능 판정으로 완료되었다.
24. 8번 리오 프로필 v1.0은 완료되었다.
25. 9~12번 중반 후보군 선정은 완료되었다.
26. 9번 Mika Arakawa / GATE-09 / 미카, 막차 환승 심사자는 프로필 v1.0까지 완료되었다.
27. 10번 Nora Weiss / BROAD-10 상세 결재는 조건부 통과했다.
28. 10번 BROAD-10 조건부 해소 문서는 통과로 승격 가능 판정으로 완료되었다.
29. 10번 Nora Weiss / BROAD-10 프로필 v1.0은 완료되었다.
30. 11번 Mara Kincaid / CLAUSE-11 상세 결재는 조건부 통과했다.
31. 11번 CLAUSE-11 조건부 해소 문서는 통과로 승격 가능 판정으로 완료되었다.
32. 11번 Mara Kincaid / CLAUSE-11 프로필 v1.0은 완료되었다.
33. 12번 Rafaela Costa / LEDGER-12 상세 결재는 조건부 통과했다.
34. 12번 LEDGER-12 조건부 해소 문서는 통과로 승격 가능 판정으로 완료되었다.
35. 12번 Rafaela Costa / LEDGER-12 프로필 v1.0은 완료되었다.
36. 13번 GUARD-13 상세 결재 전 후보 재검토는 조건부 유지 판정으로 완료되었다.
37. 13번 GUARD-13 상세 결재는 조건부 통과 판정으로 완료되었다.
38. 13번 GUARD-13 조건부 해소 문서는 통과로 승격 가능 판정으로 완료되었다.
39. 13번 GUARD-13 프로필 v1.0은 완료되었다.
40. 코드명/해금 순번 마이그레이션 판정은 완료되었다.
41. 14~20 글로벌 이름/원점 재검토는 조건부 통과로 완료되었다.
42. 15번 Maya Chen / MODEL-15 상세 결재는 조건부 통과했다.
43. 15번 MODEL-15 조건부 해소 문서는 통과로 승격 가능 판정으로 완료되었다.
44. 15번 Maya Chen / MODEL-15는 E10_C05 개방 후 후보로 보존한다.
45. 17번 Omar Al-Hadid / LOCKOUT-17 산출물은 기능 초안/보류 산출물로만 취급한다.
46. 17번 LOCKOUT-17은 캠페인 미개방으로 대기한다.
47. Leila Haddad / NAME-18 상세 결재로 넘어가지 않는다.
48. 다음 작업은 출시 초기 플레이어블 포인터 보정 완료 검수다.
41. NPC는 플레이어블 로스터와 별도로 만든다.
42. NPC도 이름만 나열하지 말고, 시설/상태 반응/잘못 믿는 것/플레이어블이 아닌 이유를 붙인다.
...
PATCH-02 이후 3~7번 기존 후보 산출물은 아래 범위로 보존하되 출시 초기 해금 대상으로 쓰지 않는다:
...
PATCH-02는 legacy_code로 보존되며 출시 초기 +1 확정이 아니다. OPEN-HOST는 3번 산출 번호를 보존하되 NPC 선등장을 유지하고 출시 초기 U5 전환은 금지한다.
3~7번에는 새 로봇을 넣지 않는다.
...
다음 작업은 출시 초기 플레이어블 포인터 보정 완료 검수만 다룬다.
...
주의:
- 1번은 윤서로 고정한다.
- 2번은 PATCH-02 legacy_code와 기능 산출물로 보존하되 출시 초기 +1 확정으로 쓰지 않는다.
- 8번은 리오 후보로 고정한다.
- OPEN-HOST는 R01 NPC 선등장 후 플레이어블 전환 후보로 3~7번 또는 후속 슬롯에 둘 수 있다.
- 3~7번은 기존 후보 산출물로만 보존한다. 3 OPEN-HOST는 NPC 선등장 후 전환 후보이며, 4~7은 출시 후 보류다.
...
11번 CLAUSE-11 프로필 v1.0도 완료되었다.
완료 문서:
story/06_characters/clause_11_profile_v1_0.md

12번 LEDGER-12 상세 결재, 조건부 해소, 프로필 v1.0도 완료되었다.
완료 문서:
story/06_characters/ledger_12_playable_decision_v0_1.md
story/06_characters/ledger_12_playable_condition_patch_v0_1.md
story/06_characters/ledger_12_profile_v1_0.md
...
다음에는 출시 초기 플레이어블 포인터 보정 완료 검수만 작성하라.
...
```text
윤서 1번, PATCH-02 legacy_code 보존/U1~U4 보류, 리오 8번 기능 산출물 보존을 잠그고,
OPEN-HOST를 3번 산출 번호 / R01 NPC 선등장 / 출시 초기 U5 전환 금지로 반영하며,
...
현재 기준에서는 `story/06_characters/playable_20_roster_blueprint_v0_1.md`, `story/06_characters/playable_20_name_registry_v0_1.md`, `story/06_characters/playable_20_campaign_open_order_rebuild_v0_1.md`, `story/06_characters/playable_20_campaign_open_order_rebuild_result_v0_1.md`, `story/06_characters/playable_20_global_name_origin_correction_v0_1.md`, `story/06_characters/playable_20_profile_number_code_migration_decision_v0_1.md`, `story/06_characters/playable_slots_14_to_20_global_name_origin_review_v0_1.md`, `story/06_characters/model_15_playable_decision_v0_1.md`, `story/06_characters/model_15_playable_condition_patch_v0_1.md`, `story/06_characters/model_15_profile_v1_0.md`, `story/06_characters/lockout_17_playable_decision_v0_1.md`, `story/06_characters/lockout_17_playable_condition_patch_v0_1.md`, `story/06_characters/lockout_17_profile_v1_0.md`, `story/06_characters/unopened_campaign_playable_hold_gate_v0_1.md`를 먼저 보고, 새 프로필을 바로 작성하지 않는다. 다음 작업은 **출시 초기 플레이어블 포인터 보정 완료 검수**다.
