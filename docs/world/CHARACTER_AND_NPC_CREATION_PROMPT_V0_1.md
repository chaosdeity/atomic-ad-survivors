...
보급소/NPC 기준:
41. story/02_hub/silence_outpost.md
42. story/02_hub/npcs.md
43. story/02_hub/mina_npc_profile_v1_0.md
44. story/02_hub/mina_npc_drama_draft_v0_1.md
45. story/05_progression/run_story_hooks.md
46. story/05_progression/story_trigger_schema.md
...
8. 로스터 중복 검사를 한다.
9. 다음 작업은 3~7번 초반 플레이어블 후보 선정이다.
10. OPEN-HOST는 3~7번 또는 후속 전환 후보로 비교한다.
...
PATCH는 2번으로 확정되었으므로 OPEN-HOST는 3~7번 또는 후속 전환 후보로 비교한다.
...
현재 기준에서는 `story/06_characters/playable_20_roster_blueprint_v0_1.md`와 `story/06_characters/patch_playable_2nd_slot_final_decision_v0_1.md`를 먼저 보고, 20명을 다시 나열하지 않는다. 다음 작업은 **3~7번 초반 플레이어블 후보 선정**이다.
