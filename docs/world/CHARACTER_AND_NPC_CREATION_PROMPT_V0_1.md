...
보급소/NPC 기준:
49. story/02_hub/silence_outpost.md
50. story/02_hub/npcs.md
51. story/02_hub/mina_npc_profile_v1_0.md
52. story/02_hub/mina_npc_drama_draft_v0_1.md
53. story/05_progression/run_story_hooks.md
54. story/05_progression/story_trigger_schema.md
...
16. 다음 작업은 6번 차유건 / METER-06 / 폐충전소 계량자 상세 결재다.
17. NPC는 플레이어블 로스터와 별도로 만든다.
18. NPC도 이름만 나열하지 말고, 시설/상태 반응/잘못 믿는 것/플레이어블이 아닌 이유를 붙인다.
...
다음 작업은 6번 차유건 / METER-06 / 폐충전소 계량자 상세 결재만 다룬다.
...
다음에는 6번 차유건 / METER-06 / 폐충전소 계량자 상세 결재만 작성하라.
...
현재 기준에서는 `story/06_characters/playable_20_roster_blueprint_v0_1.md`, `story/06_characters/patch_playable_2nd_slot_final_decision_v0_1.md`, `story/06_characters/playable_slots_3_to_7_candidate_selection_v0_1.md`, `story/06_characters/discharge_hold_patient_playable_decision_v0_1.md`, `story/06_characters/discharge_hold_patient_playable_condition_patch_v0_1.md`, `story/06_characters/discharge_hold_patient_profile_v1_0.md`, `story/06_characters/playable_20_name_registry_v0_1.md`, `story/06_characters/return_recipient_playable_decision_v0_1.md`, `story/06_characters/return_recipient_playable_condition_patch_v0_1.md`, `story/06_characters/return_recipient_profile_v1_0.md`를 먼저 보고, 20명을 다시 나열하지 않는다. 다음 작업은 **6번 차유건 / METER-06 / 폐충전소 계량자 상세 결재**다.
