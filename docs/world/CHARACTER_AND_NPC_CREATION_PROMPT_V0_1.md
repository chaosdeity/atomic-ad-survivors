...
보급소/NPC 기준:
58. story/02_hub/silence_outpost.md
59. story/02_hub/npcs.md
60. story/02_hub/mina_npc_profile_v1_0.md
61. story/02_hub/mina_npc_drama_draft_v0_1.md
62. story/05_progression/run_story_hooks.md
63. story/05_progression/story_trigger_schema.md
...
- 리오는 8번째 플레이어블 후보로 통과로 승격 가능 판정을 받았다.
...
24. 다음 작업은 RIO-08 프로필 v1.0 작성이다.
25. NPC는 플레이어블 로스터와 별도로 만든다.
26. NPC도 이름만 나열하지 말고, 시설/상태 반응/잘못 믿는 것/플레이어블이 아닌 이유를 붙인다.
...
다음 작업은 RIO-08 프로필 v1.0 작성만 다룬다.
