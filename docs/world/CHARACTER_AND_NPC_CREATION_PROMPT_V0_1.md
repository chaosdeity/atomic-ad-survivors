...
보급소/NPC 기준:
43. story/02_hub/silence_outpost.md
44. story/02_hub/npcs.md
45. story/02_hub/mina_npc_profile_v1_0.md
46. story/02_hub/mina_npc_drama_draft_v0_1.md
47. story/05_progression/run_story_hooks.md
48. story/05_progression/story_trigger_schema.md
...
6. 4번은 퇴원 보류 환자, 5번은 반송 수취인, 6번은 폐충전소 계량자, 7번은 침묵권 피난자로 둔다.
7. 리오는 8번 후보 슬롯으로 잠근다.
8. 3~7번에는 새 로봇을 넣지 않는다.
9. 4번 퇴원 보류 환자 상세 결재는 조건부 통과로 완료되었다.
10. 다음 작업은 퇴원 보류 환자 보완 문서다.
...
- 4번 퇴원 보류 환자 / R02 의료·보험
- 5번 반송 수취인 / R03 물류·반품
- 6번 폐충전소 계량자 / R04 정품·충전·산업
- 7번 침묵권 피난자 / R08 비상보급·대피
...
현재 기준에서는 `story/06_characters/playable_20_roster_blueprint_v0_1.md`, `story/06_characters/patch_playable_2nd_slot_final_decision_v0_1.md`, `story/06_characters/playable_slots_3_to_7_candidate_selection_v0_1.md`, `story/06_characters/discharge_hold_patient_playable_decision_v0_1.md`를 먼저 보고, 20명을 다시 나열하지 않는다. 다음 작업은 **퇴원 보류 환자 보완 문서**이다.
