...
- 다음 작업은 6번 차유건 / METER-06 / 폐충전소 계량자 상세 결재다.
- 리오는 8번 후보 슬롯으로 둔다.
- 3~7번에는 새 로봇을 넣지 않는다.
...
다음 방에서는 20명을 다시 늘어놓지 않는다. PATCH는 2번으로 잠겼고 3~7번 후보 선정, 4번 퇴원 보류 환자 상세 결재, 보완 문서, 프로필 v1.0, 플레이어블 20인 이름 레지스트리 v0.1, 5번 반송 수취인 상세 결재, 보완 문서, 프로필 v1.0도 완료되었으므로, 6번 차유건 / METER-06 / 폐충전소 계량자 상세 결재만 작성한다.
