...
- 플레이어블 20인 이름 레지스트리 v0.1은 작성 완료되었다. 5~7번 이름/코드명은 L3 후보이며, 각 상세 결재 때 확정 또는 수정한다.
- 5번 반송 수취인 상세 결재는 조건부 통과했다. 송장/포장끈/반송 스티커 중심, R03-L01~L02 제한, HP 0 수취인 확인 실패를 보완해야 한다.
...
다음 방에서는 20명을 다시 늘어놓지 않는다. PATCH는 2번으로 잠겼고 3~7번 후보 선정, 4번 퇴원 보류 환자 상세 결재, 보완 문서, 프로필 v1.0, 플레이어블 20인 이름 레지스트리 v0.1, 5번 반송 수취인 상세 결재도 완료되었으므로, 5번 한이루 / RETURN-05 / 반송 수취인 조건부 해소 문서만 작성한다.
