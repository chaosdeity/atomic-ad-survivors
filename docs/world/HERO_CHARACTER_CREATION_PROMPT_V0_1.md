...
PATCH-02 legacy_code 보존 / 출시 초기 +1 확정 아님 / U1~U4 보류

3번:
OPEN-HOST / 서이겸 / 전직 오픈하우스 안내인
R01 NPC 선등장 / 출시 초기 U5 전환 금지 / 후속 플레이어블 전환 후보

4번:
강하람 / HOLD-04 / 하람, 퇴원 보류자
프로필 v1.0 기능 산출물 보존 / 출시 후 보류
...
17. story/06_characters/gate_09_playable_decision_v0_1.md
18. story/06_characters/gate_09_playable_condition_patch_v0_1.md
19. story/06_characters/gate_09_profile_v1_0.md
...
28. story/06_characters/broad_10_profile_v1_0.md
29. story/06_characters/clause_11_profile_v1_0.md

NPC 충돌 방지:
30. story/03_regions/r01_document_index_v0_1.md
31. story/03_regions/r01_campaign1_npc_roster_v0_1.md
32. story/03_regions/r01_npc_data_schema_application_v0_1.md
33. docs/world/NPC_PRODUCTION_ROADMAP_V0_1.md
...
```text
1. 9번 Mika Arakawa / GATE-09 상세 결재는 완료되었다.
2. 완료 문서는 story/06_characters/gate_09_playable_decision_v0_1.md다.
3. GATE-09 조건부 해소 문서는 완료되었다.
4. 완료 문서는 story/06_characters/gate_09_playable_condition_patch_v0_1.md다.
5. GATE-09 프로필 v1.0은 완료되었다.
6. 완료 문서는 story/06_characters/gate_09_profile_v1_0.md다.
7. 10번 Nora Weiss / BROAD-10 상세 결재는 조건부 통과했다.
8. 완료 문서는 story/06_characters/broad_10_playable_decision_v0_1.md다.
9. BROAD-10 조건부 해소 문서는 완료되었다.
10. 완료 문서는 story/06_characters/broad_10_playable_condition_patch_v0_1.md다.
11. BROAD-10 프로필 v1.0은 완료되었다.
12. 완료 문서는 story/06_characters/broad_10_profile_v1_0.md다.
13. 11번 Mara Kincaid / CLAUSE-11 상세 결재는 조건부 통과했다.
14. 11번 CLAUSE-11 조건부 해소 문서는 완료되었다.
15. 완료 문서는 story/06_characters/clause_11_playable_condition_patch_v0_1.md다.
16. CLAUSE-11 프로필 v1.0은 완료되었다.
17. 완료 문서는 story/06_characters/clause_11_profile_v1_0.md다.
18. 12번 Rafaela Costa / LEDGER-12 상세 결재는 조건부 통과했다.
19. 12번 LEDGER-12 조건부 해소 문서는 완료되었다.
20. 완료 문서는 story/06_characters/ledger_12_playable_condition_patch_v0_1.md다.
21. LEDGER-12 프로필 v1.0은 완료되었다.
22. 완료 문서는 story/06_characters/ledger_12_profile_v1_0.md다.
23. 13번 GUARD-13 상세 결재 전 후보 재검토는 조건부 유지 판정으로 완료되었다.
24. 완료 문서는 story/06_characters/guard_13_pre_decision_review_v0_1.md다.
25. 13번 GUARD-13 상세 결재는 조건부 통과 판정으로 완료되었다.
26. 완료 문서는 story/06_characters/guard_13_playable_decision_v0_1.md다.
27. 13번 GUARD-13 조건부 해소는 통과로 승격 가능 판정으로 완료되었다.
28. 완료 문서는 story/06_characters/guard_13_playable_condition_patch_v0_1.md다.
29. 13번 GUARD-13 프로필 v1.0은 완료되었다.
30. 완료 문서는 story/06_characters/guard_13_profile_v1_0.md다.
31. 코드명/해금 순번 마이그레이션 판정은 완료되었다.
32. 14~20 글로벌 이름/원점 재검토는 조건부 통과로 완료되었다.
33. 15번 Maya Chen / MODEL-15 상세 결재는 조건부 통과했다.
34. 15번 MODEL-15 조건부 해소는 통과로 승격 가능 판정으로 완료되었다.
35. 15번 Maya Chen / MODEL-15는 E10_C05 개방 후 후보로 보존한다.
36. 17번 Omar Al-Hadid / LOCKOUT-17 산출물은 기능 초안/보류 산출물로만 취급한다.
37. 17번 LOCKOUT-17은 캠페인 미개방으로 대기한다.
38. Leila Haddad / NAME-18 상세 결재로 넘어가지 않는다.
39. 다음 작업은 출시 초기 플레이어블 포인터 보정 완료 검수다.
```
