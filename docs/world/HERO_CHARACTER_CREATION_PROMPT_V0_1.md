...
NPC 충돌 방지:
25. story/03_regions/r01_document_index_v0_1.md
26. story/03_regions/r01_campaign1_npc_roster_v0_1.md
27. story/03_regions/r01_npc_data_schema_application_v0_1.md
...
3. 다음 작업은 story/06_characters/gate_09_playable_condition_patch_v0_1.md를 작성하는 것이다.
4. 조건부 해소 후 최종 통과 시 story/06_characters/gate_09_profile_v1_0.md로 프로필을 고정한다.
```
